...
echo $html;
        ...
        echo "<br>";
        echo "custom_title ".$value_custom_meta_use_custom_title;
        echo "<br>";
        echo "title ".$value_custom_meta_custom_header_title;
        echo "<br>";
        echo "sub_title ".$value_custom_meta_custom_header_sub_title;
        echo "<br>";
